%Record analog and imaging data with VDAQ
%This script takes care of simultaneously recording analog and imaging
%data exploiting the built in capabilities of VDAQ and the preimium SI
% 
% Pablo - Jul 23th 2022.
...
%%
close all
sample_rate = 5000; %samples per second - for plotting

clc
fprintf('Starting analog and imaging recording...');

%% Sync file names between imagign and analog data
% 
